## IMPORTANT! When uplaoding to your webserver copy index.html to the root directory of the website outside of the html folder, but keep a copy inside the html folder as well.
